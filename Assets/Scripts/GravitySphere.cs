...
namespace Scripts
{
	public class GravitySphere : GravitySource
	{
		...
		[SerializeField] private float outerFalloffRadius = 15f;

		[SerializeField, Min(0)] private float innerFalloffRadius = 1f, innerRadius = 5f;
		...
		void OnValidate()
		{
			innerFalloffRadius = Mathf.Max(innerRadius, 0f);
